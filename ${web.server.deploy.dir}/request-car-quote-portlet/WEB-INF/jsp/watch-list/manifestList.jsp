...
<div id="manifest" class="tab-pane fade">
   ...
   <table id="manifestTableId" style="table-layout: fixed;" class="dashboard-list">
	  <thead class="hidden-xs">	 
		 <tr>
			<th>Your Vehicle Registration Number <br/><input type="text"> </th>
			<th>Policy Expiry Date <br/><input type="date"> </th>
		 </tr>
		 <tr>
			<th>Claim In Previous Policy? <br/><input type="text"></th>
			<th>Previous No Claim Bonus(NCB %)? <br/>
				<select>
					<option>0</option>
					<option>20</option>
					<option>25</option>
		 ...
		 <tr>
			<th>Email Id <br/><input type="email" name="email"></th>
			<th>Mobile No <br/><input type="tel" /> </th>
		 </tr>
	  </thead>
