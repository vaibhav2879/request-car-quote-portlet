	...
	<div id="dashboard-features-info">
       <div class="features-info-container">
            ...
            <div class="tab-content mobremovemargin">
                ...
                <%@ include file="/WEB-INF/jsp/watch-list/watchlist.jsp" %>
                
                <%@ include file="/WEB-INF/jsp/watch-list/manifestList.jsp" %>
                
                <%@ include file="/WEB-INF/jsp/watch-list/pickuplist.jsp" %>
                
                <%-- <%@ include file="/WEB-INF/jsp/watch-list/draftShipmentList.jsp" %>
                
                <%@ include file="/WEB-INF/jsp/watch-list/savedSearchList.jsp" %> --%>
