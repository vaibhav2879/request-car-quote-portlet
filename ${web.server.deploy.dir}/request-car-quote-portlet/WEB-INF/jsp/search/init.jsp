...
<c:set var="SHPCRE"><%=PropsUtil.get("SHPCRE") %></c:set>
<c:set var="INTRNST"><%=PropsUtil.get("INTRNST") %></c:set>
<c:set var="DELVERD"><%=PropsUtil.get("DELVERD") %></c:set>
<c:set var="DELVERY"><%=PropsUtil.get("DELVERY") %></c:set>    
<c:set var="PCKDUP"><%=PropsUtil.get("PCKDUP") %></c:set>
<c:set var="OUTFDL"><%=PropsUtil.get("OUTFDL") %></c:set>
<c:set var="AWTCOL"><%=PropsUtil.get("AWTCOL") %></c:set>
<c:set var="COLLCTD"><%=PropsUtil.get("COLLCTD") %></c:set>
<c:set var="CANCLD"><%=PropsUtil.get("CANCLD") %></c:set>
<c:set var="PRTDEL"><%=PropsUtil.get("PRTDEL") %></c:set>
<%
